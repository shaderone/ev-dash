...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint0Fill.shader = ui.Gradient.linear(Offset(size.width * 0.2325310, size.height * 0.1075232), Offset(size.width * 0.05690000, size.height * 0.3567081), [const Color(0xff6B4339).withOpacity(1), const Color(0xff8B7268)], [0, 1]);
    ...
    paint2Fill.shader = ui.Gradient.linear(Offset(size.width * 1.251189, size.height * 1.259853), Offset(size.width * 0.1584545, size.height * 0.01942938), [const Color(0xff6B4339).withOpacity(1), const Color(0xff6B4339).withOpacity(0)], [0, 1]);
...
class AverageMillagePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint0Fill = Paint()..style = PaintingStyle.fill;
    paint0Fill.shader = ui.Gradient.linear(Offset(size.width * 0.9125874, size.height * -0.000008129217), Offset(size.width * 0.8369860, size.height * 1.762893), [const Color(0xff6B4339).withOpacity(1), const Color(0xff7D7472).withOpacity(0.79)], [0, 1]);
    canvas.drawPath(path_0, paint0Fill);
  }
